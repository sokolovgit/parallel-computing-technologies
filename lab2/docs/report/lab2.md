...
[ОПИС: Опишіть реалізацію Producer-Consumer за Oracle tutorial (guarded blocks, wait/notifyAll). Як змінено тип даних на масив чисел заданого розміру (100, 1000, 5000); як producer заповнює буфер, як consumer читає; як перевіряється коректність (наприклад, перевірка суми або послідовності згенерованих чисел).]

![](media/image6.png){width="6.268055555556in" height="3.5in"}

**Рисунок 2.1** — [SCREENSHOT: Консольний вивід Producer-Consumer для розміру буфера 100 (або фрагмент виводу). Показати, що програма завершується коректно та/або виводить результат перевірки. Вставте як media/image6.png]

![](media/image7.png){width="6.268055555556in" height="3.5in"}

**Рисунок 2.2** — [SCREENSHOT: Тест для розміру 1000. Вставте як media/image7.png]

![](media/image8.png){width="6.268055555556in" height="3.5in"}

**Рисунок 2.3** — [SCREENSHOT: Тест для розміру 5000. Вставте як media/image8.png]

[ПОЯСНЕННЯ: Висновок про правильність роботи програми при різних розмірах буфера: чи всі згенеровані числа спожиті без втрат і дублювань, чи сума/перевірка збігається з очікуваною.]
...
[Вставте лістинг класів Producer-Consumer: буфер (наприклад, Drop або BoundedBuffer), Producer, Consumer, main-клас з тестами для розмірів 100, 1000, 5000.]
