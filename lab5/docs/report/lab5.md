...
Загалом практикум підкреслює роль **високорівневих** засобів Java (`ExecutorService`, потоки) при побудові імітацій, де важливі коректна синхронізація спільного стану та відокремлення обчислення від спостереження за результатами. Подальше завершення пунктів 4 і бонусу доповнить звіт теоретичним порівнянням і матеріалами Петрі у тому ж форматі, що й для рисунків 4.1 та бонусу.
