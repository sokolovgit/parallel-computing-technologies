...
У додатку наведено тести коректності послідовної та паралельної реалізацій (pytest). Файли в проєкті: `course-work/project/tests/`. Довгі тести позначені маркером `slow` (великі масиви).

## Б.1. `test_bitonic_sort.py`
...
## Б.2. `test_bitonic_sort_large.py`
