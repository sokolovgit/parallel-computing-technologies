...
- `lab6/project` is MPI (Open MPI) coursework: C under `src/` (e.g. `task1_p2p.c`), output in `bin/`; `justfile` recipe `task1` builds with `mpicc` and runs `mpirun -np 2`; report draft in `lab6/docs/report/lab6.md`.
